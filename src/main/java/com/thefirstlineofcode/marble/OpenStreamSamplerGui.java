...
public class OpenStreamSamplerGui extends AbstractSamplerGui {
	...
	private JCheckBox sendingInitialPresence;
	...
	private void init() {
		...
		JPanel initialPresencePanel = new HorizontalPanel();
		initialPresencePanel.setBorder(BorderFactory.createTitledBorder(JMeterUtils.getResString("xmpp_initial_presence_config")));
		initialPresencePanel.add(createInitialPresencePanel());
		
		mainPanel.add(hostPanel);
		mainPanel.add(securityPanel);
		mainPanel.add(loginPanel);
		mainPanel.add(initialPresencePanel);
	...
	private Component createInitialPresencePanel() {
		sendingInitialPresence = new JCheckBox(JMeterUtils.getResString("xmpp_sending_initial_presence"));
		
		JPanel initialPresencePanel = new JPanel(new BorderLayout(5, 0));
		initialPresencePanel.add(sendingInitialPresence, BorderLayout.CENTER);
		
		return initialPresencePanel;
	}
	...
	public void configure(TestElement element) {
		...
		sendingInitialPresence.setSelected(openStreamSampler.isSendingInitialPresence());
	}
	...
	public void modifyTestElement(TestElement sampler) {
		...
		openStreamSampler.setSendingInitialPresence(sendingInitialPresence.isSelected());
	...
	public void clearGui() {
		...
		sendingInitialPresence.setSelected(true);
	}
